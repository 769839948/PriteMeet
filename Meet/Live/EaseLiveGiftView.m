...
- (UICollectionView*)collectionView
{
    if (_collectionView == nil) {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, _bottomView.height - 54.f) collectionViewLayout:flowLayout];
...
- (UILabel*)fortuneLabel
{
    if (_fortuneLabel == nil) {
        ...
        _fortuneLabel.textColor = [UIColor colorWithHexString:HomeDetailViewNameColor];
...
- (UIButton*)reChargeButton
{
    if (_reChargeButton == nil) {
        ...
        _reChargeButton.backgroundColor = [UIColor colorWithHexString:HomeDetailViewNameColor];
