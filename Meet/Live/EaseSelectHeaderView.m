...
- (void)setupView
{
    ...
    for (int i = 0; i < [_dataArray count]; i++) {
        ...
        [tagBtn setTitleColor:[UIColor colorWithHexString:lineLabelBackgroundColor] forState:UIControlStateNormal];
        [tagBtn setTitleColor:[UIColor colorWithHexString:HomeDetailViewNameColor] forState:UIControlStateSelected];
        tagBtn.tag = i + 100;
        if (i == 0) {
            tagBtn.selected = YES;
            _selectBtn = tagBtn;
    ...
    _selectView.backgroundColor = [UIColor colorWithHexString:lineLabelBackgroundColor];
