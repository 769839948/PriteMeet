...
{
    if (_subWindow == nil) {
        _subWindow = [[UIWindow alloc] initWithFrame:CGRectMake(0, ScreenHeight, ScreenWidth, 290.f)];
    }
    return _subWindow;
}
...
- (EaseLiveHeaderListView*)headerListView
{
    if (_headerListView == nil) {
        _headerListView = [[EaseLiveHeaderListView alloc] initWithFrame:CGRectMake(kDefaultLeft, 71.f, ScreenWidth - 30.f, 30.f)];
...
- (UIButton*)startButton
{
    ...
    if (_startButton == nil) {
        ...
        [_startButton setBackgroundColor:[UIColor colorWithHexString:HomeDetailViewNameColor]];
...
- (UIButton*)microphoneBtn
{
    if(_microphoneBtn == nil) {
        ...
        _microphoneBtn.frame = CGRectMake(ScreenWidth - 160, kDefaultTop, 30, 30);
...
- (UIButton*)flashBtn
{
    if (_flashBtn == nil) {
        ...
        _flashBtn.frame = CGRectMake(ScreenWidth - 120, kDefaultTop, 30, 30);
...
- (UIButton*)changeBtn
{
    if (_changeBtn == nil) {
        ...
        _changeBtn.frame = CGRectMake(ScreenWidth - 80, kDefaultTop, 30, 30);
...
- (UIButton*)closeBtn
{
    if (_closeBtn == nil) {
        ...
        _closeBtn.frame = CGRectMake(ScreenWidth - 40, kDefaultTop, 30, 30);
...
- (void)closeAction
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.subWindow.top = ScreenHeight;
...
-(void)showTheLoveAction
{
    ...
    CGPoint fountainSource = CGPointMake(ScreenWidth - (20 + 50/2.0), _chatview.height - 100);
...
//    CameraServer.capteureDevicePos = 
    ...
    if ([[CameraServer server] setFlashState:UCloudCameraCode_Off]) {
        NSLog(@"true");
    }else{
        NSLog(@"false");
    }
...
- (void)didSelectMessageButton
{
    ...
    [navigationController.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor colorWithHexString:HomeDetailViewNameColor], NSForegroundColorAttributeName, [UIFont systemFontOfSize:18.0], NSFontAttributeName, nil]];
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.subWindow.top = ScreenHeight - self.subWindow.height;
    }];
}
...
- (void)keyboardWillChangeFrame:(NSNotification *)notification
{
    ...
    if ([self.subWindow isKeyWindow]) {
        if (y == ScreenHeight) {
            [UIView animateWithDuration:0.3 animations:^{
                self.subWindow.top = ScreenHeight - 290.f;
                self.subWindow.height = 290.f;
            }];
        } else  {
            [UIView animateWithDuration:0.3 animations:^{
                self.subWindow.top = 0;
                self.subWindow.height = ScreenHeight;
            }];
        }
    }
}
