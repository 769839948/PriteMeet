...
- (UIImageView*)headImageView
{
    if (_headImageView == nil) {
        ...
        _headImageView.backgroundColor = [UIColor colorWithHexString:lineLabelBackgroundColor];
    }
...
- (UILabel*)contentLabel
{
    if (_contentLabel == nil) {
        ...
        _contentLabel.textColor = [UIColor colorWithHexString:HomeDetailViewNameColor];
