...
- (instancetype)init
{
    self = [super initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenWidth)];
    if (self) {
...
{
    if (_bgView == nil) {
        _bgView = [[UIView alloc] initWithFrame:CGRectMake(52.f, 100.f, ScreenWidth - 104, ScreenWidth/2 + 100.f + kMargin * 4)];
...
- (UIImageView*)printImageView
{
    if (_printImageView == nil) {
        ...
        _printImageView.frame = CGRectMake(5.f, 5.f, _bgView.width - 10.f, ScreenHeight/2);
...
- (UIButton*)cancelButton
{
    if (_cancelButton == nil) {
        ...
        [_cancelButton setTitleColor:[UIColor colorWithHexString:HomeDetailViewNameColor] forState:UIControlStateNormal];
