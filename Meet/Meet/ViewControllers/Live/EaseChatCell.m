...
{
    if (message) {
        CGRect rect = [[EaseChatCell _attributedStringWithMessage:message] boundingRectWithSize:CGSizeMake(ScreenWidth - 105, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin context:nil];
