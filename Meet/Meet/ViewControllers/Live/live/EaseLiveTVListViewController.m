...
@interface EaseLiveTVListViewController () <UIScrollViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,EaseSelectHeaderViewDelegate>
...
{
    if (_headerView == nil) {
        _headerView = [[EaseSelectHeaderView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, 48.f)];
