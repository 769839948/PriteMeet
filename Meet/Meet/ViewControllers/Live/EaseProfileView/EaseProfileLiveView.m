...
- (instancetype)initWithUsername:(NSString*)username;
{
    ...
    if (self) {
        ...
        if (username.length > 0 && ![username isEqualToString:[EMClient sharedClient].currentUsername]) {
            ...
            line1.backgroundColor = [UIColor colorWithHexString:lineLabelBackgroundColor];
            ...
            line2.backgroundColor = [UIColor colorWithHexString:lineLabelBackgroundColor];
        ...
        line.backgroundColor = [UIColor colorWithHexString:lineLabelBackgroundColor];
...
{
    if (_descLabel == nil) {
        _descLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, _followTextView.bottom + 10.f, ScreenWidth, 16.f)];
        _descLabel.font = [UIFont systemFontOfSize:14.f];
        _descLabel.textColor = [UIColor colorWithHexString:HomeDetailViewNameColor];
...
- (EaseProfileTextView*)followTextView
{
    if (_followTextView == nil) {
        _followTextView = [[EaseProfileTextView alloc] initWithFrame:CGRectMake(ScreenWidth/2 - 100, 89.f, 100.f, 18.f) name:NSLocalizedString(@"profile.follow", @"Follow") number:@"10"];
    }
...
- (EaseProfileTextView*)followingTextView
{
    if (_followingTextView == nil) {
        _followingTextView = [[EaseProfileTextView alloc] initWithFrame:CGRectMake(ScreenWidth/2, 89.f, 100.f, 18.f) name:NSLocalizedString(@"profile.following", @"Following") number:@"100"];
    }
...
{
    if (_headTagView == nil) {
        _headTagView = [[EaseTagView alloc] initWithFrame:CGRectMake((ScreenWidth - 86.f)/2, self.height - 206.f - 30, 86.f, 108.f) name:_username imageName:nil];
        [_headTagView setNameColor:[UIColor colorWithHexString:HomeDetailViewNameColor]];
    }
    return _headTagView;
}
...
- (UIButton*)followButton
{
    if (_followButton == nil) {
        ...
        _followButton.backgroundColor = [UIColor colorWithHexString:HomeDetailViewNameColor];
...
- (UIButton*)messageButton
{
    if (_messageButton == nil) {
        ...
        _messageButton.backgroundColor = [UIColor colorWithHexString:HomeDetailViewNameColor];
...
- (UIButton*)replyButton
{
    if (_replyButton == nil) {
        ...
        _replyButton.backgroundColor = [UIColor colorWithHexString:HomeDetailViewNameColor];
...
- (UIButton*)kickButton
{
    if (_kickButton == nil) {
        ...
        [_kickButton setTitleColor:[UIColor colorWithHexString:HomeDetailViewNameColor] forState:UIControlStateNormal];
...
- (UIButton*)muteButton
{
    if (_muteButton == nil) {
        ...
        [_muteButton setTitleColor:[UIColor colorWithHexString:HomeDetailViewNameColor] forState:UIControlStateNormal];
