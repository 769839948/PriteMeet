...
{
    self = [super initWithFrame:CGRectMake(0, 0, ScreenWidth, 214.f)];
    if (self) {
        self.backgroundColor = [UIColor colorWithHexString:HomeDetailViewNameColor];
        _userTagView = [[EaseTagView alloc] initWithFrame:CGRectMake((ScreenWidth - 86.f)/2, 43.f, 86.f, 108.f) name:[EMClient sharedClient].currentUsername imageName:nil];
...
{
    if (_descLabel == nil) {
        _descLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, _followersTextView.bottom + 5.f, ScreenWidth, 16.f)];
...
- (EaseProfileTextView*)followersTextView
{
    if (_followersTextView == nil) {
        _followersTextView = [[EaseProfileTextView alloc] initWithFrame:CGRectMake(34.f, _userTagView.bottom + 10.f,(ScreenWidth - 68.f)/3, 18.f) name:NSLocalizedString(@"setting.profile.followers", @"Followers") number:@"10"];
...
- (EaseProfileTextView*)followingTextView
{
    if (_followingTextView == nil) {
        _followingTextView = [[EaseProfileTextView alloc] initWithFrame:CGRectMake(_followersTextView.left + _followersTextView.width, _userTagView.bottom + 10.f,(ScreenWidth - 68.f)/3, 18.f) name:NSLocalizedString(@"setting.profile.following", @"Following")  number:@"10"];
...
- (EaseProfileTextView*)likeTextView
{
    if (_likeTextView == nil) {
        _likeTextView = [[EaseProfileTextView alloc] initWithFrame:CGRectMake(_followingTextView.left + _followingTextView.width, _userTagView.bottom + 10.f, (ScreenWidth - 68.f)/3, 18.f) name:NSLocalizedString(@"setting.profile.like", @"Like") number:@"10"];
