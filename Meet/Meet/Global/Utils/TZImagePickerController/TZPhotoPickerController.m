...
- (void)viewDidLoad {
    ...
    [self.navigationItem.rightBarButtonItem setTitleTextAttributes:@{NSFontAttributeName:[UIFont fontWithName:@"PingFangSC-Light" size:16.0f]} forState:UIControlStateNormal];
