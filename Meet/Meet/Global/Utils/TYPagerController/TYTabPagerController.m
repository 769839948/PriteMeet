...
- (void)layoutTabPagerView
{
    ...
    _pagerBarView.frame = CGRectMake(0, 0, ScreenWidth, self.contentTopEdging+[self statusBarHeight]);
    _collectionViewBar.frame = CGRectMake(0, [self statusBarHeight], ScreenWidth, self.contentTopEdging);
}
